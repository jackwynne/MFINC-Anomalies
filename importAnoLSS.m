...
%
%    filename: C:\Users\jackw\OneDrive\Documents\2019\MFINC\Code\liquidity.csv
%
% Auto-generated by MATLAB on 04-Jan-2020 12:21:42
...
opts.VariableNames = ["year", "avg_liq", "innov_liq", "traded_liq"];
...
% Import the data
liq = readtable("C:\Users\jackw\OneDrive\Documents\2019\MFINC\Code\liquidity.csv", opts);
...
% Script for importing data from the following text file:
%
%    filename: C:\Users\jackw\OneDrive\Documents\2019\MFINC\Code\US_Policy_Uncertainty_Data.csv
%
% Auto-generated by MATLAB on 02-Jan-2020 16:48:21

%% Setup the Import Options
opts = delimitedTextImportOptions("NumVariables", 6);

% Specify range and delimiter
opts.DataLines = [2, 420];
opts.Delimiter = ",";

% Specify column names and types
opts.VariableNames = ["year", "compo", "news", "FedStateLocal_Ex_disagreement", "CPI_disagreement", "Tax_expiration"];
...
% Import the data
epu = readtable("C:\Users\jackw\OneDrive\Documents\2019\MFINC\Code\US_Policy_Uncertainty_Data.csv", opts);
...
% Script for importing data from the following text file:
%
%    filename: C:\Users\jackw\OneDrive\Documents\2019\MFINC\Code\vix.csv
%
% Auto-generated by MATLAB on 11-Dec-2019 11:21:35
...
% Specify column names and types
opts.VariableNames = ["Date", "vix", "vxo", "vxn", "vxd"];
opts.VariableTypes = ["datetime", "double", "double", "double", "double"];
opts = setvaropts(opts, 1, "InputFormat", "ddMMMyyyy");
opts = setvaropts(opts, [2, 4, 5], "TrimNonNumeric", true);
opts = setvaropts(opts, [2, 4, 5], "ThousandsSeparator", ",");
opts.ExtraColumnsRule = "ignore";
opts.EmptyLineRule = "read";

% Import the data
vix = readtable("C:\Users\jackw\OneDrive\Documents\2019\MFINC\Code\vix.csv", opts);
