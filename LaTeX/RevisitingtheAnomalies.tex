...
\hypref{sec:Lit Review} of this project contains an review of three critical papers used in forming this research, and a brief look at literature relevant to the pricing anomalies. Section three contains a description of where the data for this research come from and how the pricing anomalies are calculated. Section four looks at how the anomaly portfolios perform in unconditional models from both the perspectives of excess returns and of risk-adjusted returns. The risk-adjusted analysis uses a capital asset pricing mode, Fama and French three, five and six factor models and a Fama and French six factor model with an additional volatility factor. Section five revisits the analysis from section four but this time to look at conditional models using volatility, economic policy uncertainty and market liquidity. Finally, Section six is a conclusion of the findings.
